		...
		var Fontselect = (function(){
			...
			function Fontselect(original, o) {
				...
				for (var i = 0; i < o.googleFonts.length; i++) {
					var item = o.googleFonts[i].split(':'); // Unna:regular
